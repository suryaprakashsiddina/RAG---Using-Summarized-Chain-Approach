# Instead of embedding raw chunks, we embed their summaries. These summaries form a 
# semantically dense retrieval index, while original chunks are preserved for answer 
# generation. This is the summarized chain approach.

# This enables retrieval using summaries while still referencing original content.
