# While the summarized chain logic focuses on improving retrieval, utils.py ensures 
# that the system is usable, stable, and transparent for academic interaction.
