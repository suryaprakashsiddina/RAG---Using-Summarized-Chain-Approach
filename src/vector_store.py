# This module ensures that summarized chunks are embedded and retrieved efficiently. 
# By indexing summaries instead of raw chunks, retrieval becomes more focused, which 
# directly improves the effectiveness of the RAG pipeline.

# PDF → Chunking → Summarization → Embedding → Vector Store → Retrieval → Answer
