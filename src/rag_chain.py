# This file ensures that only summarized, semantically dense chunks are retrieved, 
# while the LLM is strictly guided to answer based on retrieved context. This reduces 
# hallucination and improves response focus compared to traditional chunk-based RAG.
